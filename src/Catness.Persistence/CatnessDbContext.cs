...
public class CatnessDbContext : DbContext
{
    ...
    {
        // for migrations
        optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Username=postgres;Password=admin;Database=catness-db;Command Timeout=60;Timeout=60;Persist Security Info=True");
    }
